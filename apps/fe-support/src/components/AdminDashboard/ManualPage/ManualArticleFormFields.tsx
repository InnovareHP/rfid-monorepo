...
// Field defaults are read once at mount; the dialog remounts this on the
// resolved article, so no effect copies props into the form.
...
export function ManualArticleFormFields({
  onOpenChange,
  article,
  categories,
}: {
